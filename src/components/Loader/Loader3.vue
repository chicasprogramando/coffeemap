<template>
   <div :class="$style.containerloader3">
    <svg :class="$style.tail" width="200" height="200" viewBox="0 0 38 38" xmlns="http://www.w3.org/2000/svg">
        <defs>
            <linearGradient x1="8.042%" y1="0%" x2="65.682%" y2="23.865%" id="a">
                <stop stop-color="#7971D9" stop-opacity="0" offset="0%"/>
                <stop stop-color="#7971D9" stop-opacity=".631" offset="63.146%"/>
                <stop stop-color="#7971D9" offset="100%"/>
            </linearGradient>
        </defs>
    ...
    <svg :class="$style.coffeeicon3" width="50" height="50" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
